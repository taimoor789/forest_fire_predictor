...
export const metadata: Metadata = {
  ...
  description: 'Real-time fire risk monitoring across Canada using the Canadian Fire Weather Index System. Updated hourly with live predictions for 14,952 locations.',
